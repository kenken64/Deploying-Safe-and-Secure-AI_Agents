...
if [ "$FOCUS" = "day2" ]; then
  DIR=workshop-day2; FIRST="attack b1"; BLURB="the attack Day 1 promised you"; REAL=b1
else
  DIR=workshop-day1; FIRST="attack a1"; BLURB="watch the opening breach land"; REAL=a3
fi

cat <<EOF

=======================================================================
  Kestrel Goat is ready. Both labs are installed and seeded.
